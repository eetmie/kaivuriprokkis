...
class URDFLoader {
    ...
    // Default mesh loading function — only handles basic geometry.
    // Override loadMeshCb for OBJ/STL/DAE support.
    defaultMeshLoader(path, manager, done) {

        console.warn(`URDFLoader: Could not load model at ${ path }.\nNo loader available — set loadMeshCb for custom formats.`);
