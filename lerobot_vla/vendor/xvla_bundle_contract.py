# ─────────────────────────────────────────────────────────────────────────────
# VENDORED from spark-projects/orin-nano/xvla-runtime/xvla_runtime/bundle_contract.py
...
# bundle must carry (checkpoint hash, processor contract, tokenizer tree,
# manifest) and the normalize/unnormalize used at the robot boundary.
# verify_bundle() is what makes a schema-v2 bundle fail CLOSED before any
# TensorRT engine is built.
#
# MODIFICATIONS vs the original: none.
#
# To re-sync: copy the file again and note the new sha.
# ─────────────────────────────────────────────────────────────────────────────
