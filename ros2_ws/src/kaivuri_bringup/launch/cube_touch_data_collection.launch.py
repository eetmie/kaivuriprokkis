...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("policy_action_topic", default_value="/kaivuri/target_pose_y"),
        DeclareLaunchArgument("publish_policy_action", default_value="true"),
        DeclareLaunchArgument("policy_action_max_translation_m", default_value="0.03"),
        DeclareLaunchArgument("policy_action_max_rot_y_deg", default_value="5.0"),
        DeclareLaunchArgument("rate_hz", default_value="50.0"),
        DeclareLaunchArgument("speed_mps", default_value="0.02"),
        ...
        DeclareLaunchArgument("hold_s", default_value="0.5"),
        DeclareLaunchArgument("record_retract", default_value="false"),
        ...
        Node(
            ...
            parameters=[{
                ...
                "policy_action_topic": LaunchConfiguration("policy_action_topic"),
                "publish_policy_action": LaunchConfiguration("publish_policy_action"),
                "policy_action_max_translation_m": LaunchConfiguration("policy_action_max_translation_m"),
                "policy_action_max_rot_y_deg": LaunchConfiguration("policy_action_max_rot_y_deg"),
