...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("precreate_dataset", default_value="true"),
        ...
        DeclareLaunchArgument("obs_image_1_topic", default_value="/camera/camera1/color/rgb_decoded"),
        DeclareLaunchArgument("obs_image_2_topic", default_value="/camera/camera/color/rgb_decoded"),
        # Legacy aliases; obs_image_*_topic is the normalized interface.
        DeclareLaunchArgument("hut_image_topic", default_value="/camera/camera/color/rgb_decoded"),
        DeclareLaunchArgument("top_image_topic", default_value="/camera/camera1/color/rgb_decoded"),
        ...
        Node(
            ...
            parameters=[{
                ...
                "precreate_dataset": LaunchConfiguration("precreate_dataset"),
                "robot_type": LaunchConfiguration("robot_type"),
                "task": LaunchConfiguration("task"),
                "obs_image_1_topic": LaunchConfiguration("obs_image_1_topic"),
                "obs_image_2_topic": LaunchConfiguration("obs_image_2_topic"),
