...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("obs_image_1_topic", default_value="/camera/camera1/color/rgb_compressed"),
        DeclareLaunchArgument("obs_image_2_topic", default_value="/camera/camera/color/rgb_compressed"),
